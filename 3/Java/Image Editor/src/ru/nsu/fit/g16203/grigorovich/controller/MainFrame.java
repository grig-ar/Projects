...
import ru.nsu.fit.g16203.grigorovich.controller.FilterFactory.FilterMaker;
import ru.nsu.fit.g16203.grigorovich.controller.SettingsFactory.SettingsMaker;
...
public class MainFrame extends JFrame {
    public JToggleButton globalSelectButton = null;
    public JToggleButton globalAbsorptionButton = null;
    public JToggleButton globalEmissionButton = null;
    private static final long serialVersionUID = 1L;
    private JMenuBar menuBar;
    private JToolBar toolBar;
    private JPanel statusBar;
    private JLabel statusLabel;
    public FilterMaker filterMaker;
    public SettingsMaker settingsMaker;
    ...
    public void addMenuToolbarGroup(String title1, String tooltip1, int mnemonic1, String icon1, String actionMethod1) throws NoSuchMethodException {
        ...
        JToggleButton selectButton = new JToggleButton(selectMenuButton.getIcon());
